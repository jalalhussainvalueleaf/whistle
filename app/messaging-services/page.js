 ...
 <video
  ...
  {showContent && <div className='p-12 right-0 z-50 absolute w-8/12 space-y-4 flex flex-col items-center justify-center h-screen transition-all ease-in-out'>  
      <div className="bg-black bg-opacity-50 p-4 rounded-lg space-y-4 h-[500px] overflow-scroll text-white ">
        ...
        <p className='text-wlOrange font-semibold'>Your success is our priority!</p>
        <p>Empower your business with our exceptional features and benefits, making us the preferred choice for reliable and interactive 2-way communication on multiple channels. We take immense pride in empowering over 500 companies in India with our seamless and dependable messaging services. Our exceptional features and benefits make us the preferred choice!</p>
  ...
  <li><strong className='text-wlOrange font-semibold'>User-Friendly UI</strong> - Simplified and intuitive interface, making your experience smooth and hassle-free.</li>
  <li><strong className='text-wlOrange font-semibold'>Dedicated Resource</strong> - Get the undivided attention and resources you deserve for personalized solutions.</li>
...
<ul className='list-disc list-inside space-y-4'>
  ...
  <li><strong className='text-wlOrange font-semibold'>Easy Payments</strong> - Facilitate secure and convenient payments via SMS.</li>

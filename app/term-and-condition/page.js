...
const terms=`
        <h3 className="text-wlOrange text-2xl font-semibold">TERMS AND CONDITIONS :</h3>
       ...
       <p className="text-wlOrange text-2xl font-semibold"> Credit requests &amp; cancellation </p>
       ...
       <p className="text-wlOrange text-2xl font-semibold"> Account ethics and confidentiality </p>
       ...
       <p className="text-wlOrange text-2xl font-semibold"> Accuracy and Completeness of Information </p>
       ...
       <p className="text-wlOrange text-2xl font-semibold"> Your Use of This Website </p>
       ...
       <p className="text-wlOrange text-2xl font-semibold"> Changes To The General Terms and Conditions </p>
       ...
       <p className="text-wlOrange text-2xl font-semibold"> Privacy Policy </p>
       ...
       <p className="text-wlOrange text-2xl font-semibold"> Registration </p>
       ...
       <p className="text-wlOrange text-2xl font-semibold"> Services Activation Delay </p>
       ...
       <p className="text-wlOrange text-2xl font-semibold"> Resolution </p>
       <p>We are committed to provide resolution for any type of service delay.</p>
       <p className="text-wlOrange text-2xl font-semibold"> Communication </p>
       ...
       <p className="text-wlOrange text-2xl font-semibold"> Contact </p>
       ...
       <p className="text-wlOrange text-2xl font-semibold"> Termination </p>
       ...
       <p className="text-wlOrange text-2xl font-semibold"> Privacy guidelines </p>
       ...
       <p className="text-wlOrange text-2xl font-semibold">Use of Content</p>
       ...
       <p className="text-wlOrange text-2xl font-semibold">Fair Usage Policy</p>
       <p className="text-wlOrange text-2xl font-semibold">What is it?</p>
       ...
       <p className="text-wlOrange text-2xl font-semibold">FUPs: SMS &amp; Voice</p>
       ...
       <p className="text-wlOrange text-2xl font-semibold">Scope</p>
       ...
       <p className="text-wlOrange text-2xl font-semibold">Payment</p>
       ...
       <p className="text-wlOrange text-2xl font-semibold">Regulatory Guidelines</p>
       ...
       <p className="text-wlOrange text-2xl font-semibold">Support</p>
       <ul className="li-block">
       ...
       <p className="text-wlOrange text-2xl font-semibold"> Governing Law &amp; Jurisdiction </p>
       ...
       <p className="text-wlOrange text-2xl font-semibold"> Disclaimers </p>
       ...
       <p className="text-wlOrange text-2xl font-semibold"> Products and Services </p>
       ...
       <p className="text-wlOrange text-2xl font-semibold"> Limitation of Liability </p>
       ...
       <p className="text-wlOrange text-2xl font-semibold">Indemnification</p>
       ...
       <p className="text-wlOrange text-2xl font-semibold">Links to Third Party Websites</p>
       ...
       <p className="text-wlOrange text-2xl font-semibold">Copyright Notice</p>
       ...
       <p className="text-wlOrange text-2xl font-semibold">Submissions, Suggestions &amp; Community Participation</p>
 ...
 <video
  ...
  <Header/>
     ...
     {/* Content */}
  {/* Content */}
  {showContent && <div className='absolute right-0 z-50 flex h-screen w-8/12 flex-col items-center justify-center space-y-4 p-12 text-white transition-all ease-in-out' >
  <div className="scrollbar-thin scrollbar-thumb-gray-700 scrollbar-track-gray-800 h-[600px] w-full space-y-4 overflow-auto rounded-lg bg-black bg-opacity-50 p-4" dangerouslySetInnerHTML={{__html:terms}}/> 
  </div> }
